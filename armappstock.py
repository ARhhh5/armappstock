...
with col1:
    ...
    # ฝัง API Key ให้เป็นค่าเริ่มต้น
...
# ==========================================
# แก้ไขคำสั่งใหม่: ลบคำว่า CL.AI.docx ออก เพื่อไม่ให้ AI งงและบ่นว่าหาไฟล์ไม่เจอ
oliang_prompt = """
...
วิเคราะห์โดยอ้างอิงหลักการลงทุนและโครงสร้างด้านล่างนี้อย่างเคร่งครัด (ห้ามอ้างถึงหรือบ่นว่าเปิดไฟล์เอกสารไม่ได้ เพราะข้อมูลทั้งหมดอยู่ด้านล่างนี้แล้ว)
